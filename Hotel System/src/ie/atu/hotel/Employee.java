...
//	}	
	...
	public boolean read() {
		...
		String[] titles = {"Mr", "Ms", "Mrs", "Miss"};
		
		JTextField txtNumber = new JTextField(String.valueOf(getNumber()));
		...
		if (option == JOptionPane.OK_OPTION) {
	        ...
	        if (txtFirstName.getText().isEmpty() || txtSurname.getText().isEmpty() ||
	            txtPhoneNumber.getText().isEmpty() || txtSalary.getText().isEmpty()) {
	        ...
	        try {
	            ...
	            JOptionPane.showMessageDialog(dialog, "Invalid salary input. Please enter a valid number.", "Error", JOptionPane.ERROR_MESSAGE);
	            return false;
	        }

	        // If all fields are filled, set the employee data
